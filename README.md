...
[Lab Slides](https://docs.google.com/presentation/d/1KhDySk7tXiDoaovGN39XFggkJt5WCZ5Ue0DzZhLcDKU/edit?usp=sharing)

Please fill out the [lab document](https://docs.google.com/document/d/1_ZpwR8OAQS39QISJryON0GBG1AbQ2RqVT3LJr9OzBZ8/edit?usp=sharing).

[Lab 4 Video](https://www.youtube.com/watch?v=LJGhFBVWEz4)

---

## Part 0: Setup

1. Open the [Lab 4 code repository](https://github.com/cs123-stanford/lab_4_fall_2025) on your GitHub account. Then, fork the repository to your own GitHub account following the instructions for forking repositories.
...
3. Open the Lab 4 folder in VS Code:
...
Implement forward kinematics for the **front left, back right, and back left legs**.
...
- **Hint:** You essentially need to do an equivalent FK on each of the other legs.
...
**DELIVERABLE:** An underactuated system has more degrees of freedom that can be controlled than the number of independently controlled actuators. How many degrees of freedom does Pupper have? Is it an underactuated system?

**DELIVERABLE:** Why are underactuated systems more challenging to control?
...
- Think about why six reference positions are provided for each leg instead of only three as in Lab 3.
...
![Reference positions for each leg](../../../_static/triangle_swing_states.png)
...
**DELIVERABLE:** What are some potential setbacks that may prevent Pupper from exhibiting the gaits you listed above?
...
### TODO 3: Implement Interpolation for All Four Legs
...
- **Hint:** As you probably experienced in Lab 3, we suggest writing a custom weighted-sum function to perform interpolation rather than calling `np.interp`.
...
2. Observe the robot's movement and terminal output.
...
**DELIVERABLE:** The controller implemented is a **heuristic controller**. That means it follows a pre-programmed trajectory and doesn't use online (real-time) sensor feedback outside the motor to optimize its trajectory.

What are some potential pitfalls of this approach? How will Pupper react if you push it?

**DELIVERABLE:** Many commercial quadrupeds once used model-based controllers that solve an optimization problem online. They have increasingly shifted toward reinforcement-learning-based controllers for locomotion.

Why would it be challenging to deploy MBC/MPC on Pupper, which has lower-cost hardware and runs computation on a Raspberry Pi 5?
...
3. As described in lecture, the center of mass of the robot influences how the robot can walk, whether forward or backward. Play around with the offset values in `ee_positions` and see how that affects performance.

### Deliverables

**DELIVERABLE:** Implement two gaits for Pupper:

- Make Pupper walk fast.
- Make Pupper walk slow.

Include videos of Pupper walking fast and walking slow with your submission to Gradescope.
...
- How the center of mass affects performance.

---

## Part 7: Make Pupper Even Faster, and Race!

1. Think about ways you can make Pupper walk/run even faster.
...
**Hint:** The positions defined after the `init()` function in the `InverseKinematics` class define each of the stances.

**DELIVERABLE:** Report on what you tried to make Pupper go faster. What worked and what didn't?

2. Time your Pupper's speed to go **10 feet** (marked by the tape measure) and race against other groups!

**The fastest group will get a prize!**
...
This experience with implementing a trotting gait will be valuable for more advanced quadruped control in future projects.

While this lab is relatively simple, get prepared for what's coming in **Lab 5**!