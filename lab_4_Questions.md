...
1. Open the lab 4 code repository ([lab 4 code repository](https://github.com/cs123-stanford/lab_4_fall_2025)) on your GitHub account. Then, fork the repository to your own GitHub account following the instructions in the Forking Repositories Guide.
...
![Reference positions for each leg.](https://cs123-stanford.readthedocs.io/en/latest/_static/triangle_swing_states.png)
